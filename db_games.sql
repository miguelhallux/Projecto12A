...
--
-- Host: localhost
-- Tempo de geração: 22-Out-2024 às 23:57
...
ALTER TABLE `jogos`
  ...
  ADD KEY `cod_produtora` (`cod_produtora`);
...
--
ALTER TABLE `jogos`
  ADD CONSTRAINT `jogos_ibfk_1` FOREIGN KEY (`cod_genero`) REFERENCES `generos` (`cod`),
  ADD CONSTRAINT `jogos_ibfk_2` FOREIGN KEY (`cod_produtora`) REFERENCES `produtoras` (`cod`);
COMMIT;
